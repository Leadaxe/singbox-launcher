...
// infoIconGap — зазор между иконкой и текстом подстроки.
//
// Отрицательный по той же причине, что rowIconGap у кластеров кнопок: HBox
// добавляет theme.Padding (~4pt) между элементами, а у widget.Icon есть свой
// внутренний воздух, и знак отрывался от текста, который комментирует.
const infoIconGap float32 = -2
