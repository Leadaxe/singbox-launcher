...
> Поглощена [SPEC 135](../135-F-N-DATA_DIR_LAYOUT/SPEC.md): реализована там (XDG-пути
> на Linux — §3.1, переключатель Portable — §4.2, миграция унаследованных данных —
> §3.4). Этот документ — история постановки задачи, актуального поведения не
> описывает.
