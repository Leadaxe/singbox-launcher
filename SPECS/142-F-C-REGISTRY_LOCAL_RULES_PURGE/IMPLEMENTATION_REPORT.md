...
- PARSING_PRINCIPLES §6.2: поле, снятое по ходу обхода правилом значения или связью, для последующих связей и условий отсутствует, как снятое запретом схемы (волна 7).
...
Новая норма PARSING_PRINCIPLES §6.2 («снятое поле недоступно последующим связям/условиям»)
