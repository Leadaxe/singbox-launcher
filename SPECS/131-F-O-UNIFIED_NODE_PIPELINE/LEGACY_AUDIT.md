...
|---|---|---|
| (а) дубль реестра | 13 | **4 исправлено** (§2; №4 и №9 — контракт 1.1.11); 4 в legacy-эмиттере не снимаются поодиночке (нужно снять потребителя); 5 трогают identity живых узлов или форму отбраковки |
