...
| (б) правило значения → в реестр | 8 | **1 исправлено** (§3.1 №5, AWG MTU — контракт 1.1.5, вместе с решением владельца об исключении по входу); 2 требуют решения владельца (форма отбраковки, коды на живых узлах), 5 мелких ждут своей волны |
