...
| `uri/naive/password_only_userinfo` | `username: onlypass` | `password: onlypass` | DRIFT §7.3, вариант А, дата синхронизации с LxBox снята владельцем 18.09.2026. Эмиттер Go и так писал пароль в user-слот — ссылка читалась «наоборот» |
...
2. **naive одиночный userinfo = password** — дата синхронизации снята владельцем 18.09.2026: лаунчер релизит без ожидания, LxBox догоняет своим релизом.
