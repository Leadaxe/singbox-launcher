...
// причины, по которой узел выключило ПРИЛОЖЕНИЕ (SPEC 132, PARSING_PRINCIPLES §9.4).
//
// # Где живёт причина
//
...
// котором выключить нечего нового, обязан цикл прервать (PARSING_PRINCIPLES §9.5), и
...
// по смене тела узла, ни по смене версии ядра (PARSING_PRINCIPLES §9.4, осознанная цена
// простоты).
...
// причину заново (PARSING_PRINCIPLES §9.4).
//
...
// ТЕЛУ» (решение владельца 18.09.2026, PARSING_PRINCIPLES §9.4).
//
