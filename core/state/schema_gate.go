...
// написанный БОЛЕЕ НОВЫМ приложением (мажор 9+), эта сборка прочитает как v8,
...
//
// Обратная сторона (файл СТАРШЕ, мажор 2–7) отказом НЕ является: миграция
// v7→v8 (и цепочка ниже) для того и написана, и её вход — законная форма.
...
const SchemaMajor = SchemaVersionV8
