...
// # Исключение ядра
//
// Detour не применяется к WireGuard-узлам — правило модели
// (features/directions.md §7), и живёт оно ЗДЕСЬ, в точке применения, а не
// в fetch: тело узла обязано оставаться чистым от маршрутизации.
package config
