...
//
// ЗАЧЕМ ОТДЕЛЬНЫЙ ФАЙЛ. Писатель 0.12 (legacy_write_012.go) удаляется после
// релиза LxBox с записью 1.0; читатель — НЕТ, он живёт, пока живы файлы. Два
// разных срока жизни — два разных файла, иначе удаление писателя утянуло бы
// за собой чтение того, что уже выпущено.
