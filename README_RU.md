...
1. **Автозагрузка в Windows (с правами администратора):**
   ...
   **Вариант A: Через ярлык с запросом прав администратора**
   ...
   - На вкладке **"Ярлык"** добавьте параметр `-start` в поле "Объект":
     ```
     "C:\Program Files\singbox-launcher\singbox-launcher.exe" -start
     ```
...
**Примечания:**
- Параметр можно комбинировать с другими параметрами (если они будут добавлены в будущем)
