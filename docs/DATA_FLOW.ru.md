...
**🌐 Язык**: [English](DATA_FLOW.md) | Русский

Сводные диаграммы load / save / build / preset-toggle для Configurator'а
после SPEC 053 + 056-R-N + 057-R-N + 058-R-N. Дополняет
[WIZARD_STATE.ru.md](WIZARD_STATE.ru.md) и [TEMPLATE_REFERENCE.ru.md](TEMPLATE_REFERENCE.ru.md)
...
правил обновились. Без eager sync DNS tab и Directions tab показывали бы
