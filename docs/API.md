...
# → {"launcher":"v1.2.1","singbox":"1.14.0-lx.4","api":"debugapi/v1"}
```
...
| GET | `/version` | ✓ | `{"launcher":"v…","singbox":"1.14.0-lx.4","api":"debugapi/v1"}` |
...
```json
{
  ...
  "launcher_version": "v1.2.1",
  "singbox_version": "1.14.0-lx.4",
