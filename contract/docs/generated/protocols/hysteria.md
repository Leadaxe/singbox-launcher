...
hysteria://…?…      ──▶ link parameter   ──▶  sing-box JSON,    ──▶  checks each     ──▶  what sing-box
...
- <a id="link-common-userinfo"></a>**`userinfo`** — Fallback slot for the auth secret.
  - Type: `auth`
  - Maps to: [`auth_str`](#body-auth-str)
...
- <a id="link-proto-auth"></a>**`auth`** — Authentication secret.
...
- <a id="link-proto-upmbps"></a>**`upmbps`** — Uplink bandwidth, Mbps.
  ...
  - If invalid: removed → [`type_invalid`](../warnings.md#type_invalid) · If absent: filled in with `100`
...
- <a id="body-hop-interval"></a>**`hop_interval`** — Interval between port hops.
  - Type: duration
- <a id="body-up"></a>**`up`** — Upload bandwidth, number or string with units.
  - Type: string
...
- <a id="body-down"></a>**`down`** — Download bandwidth, number or string with units.
  - Type: string
...
- <a id="body-recv-window-conn"></a>**`recv_window_conn`** — Deprecated per-connection receive window.
  - Type: int, deprecated
- <a id="body-recv-window"></a>**`recv_window`** — Deprecated receive window.
  - Type: int, deprecated
- <a id="body-disable-mtu-discovery"></a>**`disable_mtu_discovery`** — Deprecated MTU discovery switch.
  - Type: bool, deprecated
...
- [`tls_not_applicable_quic`](../warnings.md#tls_not_applicable_quic)
  - [`tls.utls`](#body-tls-utls) — not supported by `hysteria` → removed
  - [`tls.reality`](#body-tls-reality) — not supported by `hysteria` → removed
- [`type_invalid`](../warnings.md#type_invalid)
  ...
  - [`auth`](#body-auth) — the value does not fit the field → removed
